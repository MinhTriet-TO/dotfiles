...
-- https://github.com/onsails/lspkind.nvim?tab=readme-ov-file#option-1-vanilla-neovim-lsp
-- in case that your nerdfont fucked up, go to this link and copy paste the icons
local kind_icons = {
  Text = "󰉿",
  Method = "󰆧",
  Function = "󰊕",
